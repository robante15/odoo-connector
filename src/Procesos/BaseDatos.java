...
public class BaseDatos {
    ...
    public ArrayList<hr_applicant> buscarAspirantesByName(String busqueda) {
        factory = new Factory();
        ArrayList<hr_applicant> listaAspirantes = new ArrayList<hr_applicant>();
        try {
            conn = DriverManager.getConnection(jdbcOdoo, usernameOdoo, passwordOdoo);
            String SQLQuery = "SELECT * FROM public.hr_applicant WHERE partner_name ILIKE '%" + busqueda + "%'";
            st = conn.prepareStatement(SQLQuery);
            rs = st.executeQuery();
    ...
    public ArrayList<hr_applicant> buscarAspirantesByDescripcion(String busqueda) {
        factory = new Factory();
        ArrayList<hr_applicant> listaAspirantes = new ArrayList<hr_applicant>();
        try {
            conn = DriverManager.getConnection(jdbcOdoo, usernameOdoo, passwordOdoo);
            String SQLQuery = "SELECT * FROM public.hr_applicant WHERE description ILIKE '%" + busqueda + "%'";
            st = conn.prepareStatement(SQLQuery);
            rs = st.executeQuery();
    ...
    public ArrayList<hr_applicant> buscarAspirantesBySalarioEsperado(Double busqueda) {
        factory = new Factory();
        ArrayList<hr_applicant> listaAspirantes = new ArrayList<hr_applicant>();
        try {
            conn = DriverManager.getConnection(jdbcOdoo, usernameOdoo, passwordOdoo);
            String SQLQuery = "SELECT * FROM public.hr_applicant WHERE salary_expected <=" + busqueda;
            st = conn.prepareStatement(SQLQuery);
            rs = st.executeQuery();
